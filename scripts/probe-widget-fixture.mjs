...
assertIncludes(openAiProfileHtml, "Run Doctor");
...
assertNotIncludes(openAiProfileHtml, "Command result");
assertNotIncludes(openAiProfileHtml, "No command run yet");
